...
class Notepad:
    ...
    def open_file(self):
        ...
        open file
        """
        self.file_buffer = tkinter.filedialog.askopenfilename(
        ...
        if self.file_buffer == "":
            ...
            self.ROOT.title(os.path.basename(self.file_buffer) + " - Notepad")
    ...
    def save_file(self):
        ...
        if self.file_buffer is None:
            # Save as new file
            self.file_buffer = tkinter.filedialog.asksaveasfilename(
            ...
            if self.file_buffer == "":
                ...
                file.write(self.text_area.get(1.0, tkinter.END))
                file.close()
